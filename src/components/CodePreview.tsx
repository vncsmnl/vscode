    ...
    <>
      {raw && (
        <button
          ...
          className="absolute flex items-center right-0 mx-8 gap-x-2 text-sm font-medium z-30 bg-[#191a21] px-3 py-2 rounded-md text-[#c3cfe2] ring-2 ring-[#c3cfe2] data-[copied=true]:ring-emerald-600"
        >
      ...
      <div
        ...
        className="absolute inset-0 overflow-auto leading-relaxed scrollbar scrollbar-thumb-[#191a21] scrollbar-track-transparent"
